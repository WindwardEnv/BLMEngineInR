...
// FCalcSpecConc
Rcpp::NumericVector FCalcSpecConc(Rcpp::NumericVector CConc, Rcpp::NumericVector K, Rcpp::IntegerMatrix Stoich, int NComp, int NSpec);
RcppExport SEXP _BLMEngineInR_FCalcSpecConc(SEXP CConcSEXP, SEXP KSEXP, SEXP StoichSEXP, SEXP NCompSEXP, SEXP NSpecSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type CConc(CConcSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(FCalcSpecConc(CConc, K, Stoich, NComp, NSpec));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BLMEngineInR_FCalcSpecConc", (DL_FUNC) &_BLMEngineInR_FCalcSpecConc, 5},
    {NULL, NULL, 0}
};
