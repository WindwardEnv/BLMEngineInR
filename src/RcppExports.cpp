...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CHESS(QuietFlag, ConvergenceCriteria, MaxIter, NComp, NSpec, NBLMetal, SpecK, SpecTemp, SpecDeltaH, SpecStoich, SpecCtoM, SpecName, CompType, CompName, TotConc, SysTemp, DoTox, MetalName, MetalComp, BLMetalSpecs, CATarget));
...
static const R_CallMethodDef CallEntries[] = {
    {"_BLMEngineInR_CHESS", (DL_FUNC) &_BLMEngineInR_CHESS, 21},
