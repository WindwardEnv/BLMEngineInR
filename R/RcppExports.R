...
CompUpdate <- function(X) {
    .Call(`_BLMEngineInR_CompUpdate`, X)
}
...
#'
#' @noRd
CppCalcSpecConc <- function(CompConc, K, SpecStoich, NComp, NSpec) {
    .Call(`_BLMEngineInR_CppCalcSpecConc`, CompConc, K, SpecStoich, NComp, NSpec)
}
